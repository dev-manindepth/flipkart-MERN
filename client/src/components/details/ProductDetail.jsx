...
const adURL =
  ...
  return (
    <>
      ...
      <SmallText>
        <Typography>
          <StyledBadge /> Get extra 20% off upto ₹50 on 1 items T&C
        </Typography>
        <Typography>
          <StyledBadge />
          10% off on SBI Credit Card, up to ₹1,750, on orders of ₹5000 and above
          T&C
        </Typography>
        <Typography>
          <StyledBadge />
          10% off on Kotak Bank Credit Card EMI Transactions, up to ₹2,000. On
